# LocalAI-Suite: Stream Companion 🤖🎙️

LocalAI-Suiteは、あなたのPCローカル環境で完結する「プライバシー重視・完全オフライン」のAI配信ボット＆アシスタントツール群です。
...
### 2. リポジトリのクローン
```bash
git clone https://github.com/yourusername/LocalAI-Suite.git
cd LocalAI-Suite/apps/stream-companion/electron-app
```
